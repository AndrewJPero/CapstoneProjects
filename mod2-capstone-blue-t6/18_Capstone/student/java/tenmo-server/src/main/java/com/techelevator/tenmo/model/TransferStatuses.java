...
public class TransferStatuses {
    ...
    private String transferStatusesDesc;
    ...
    public String getTransferStatusesDesc() {
        return transferStatusesDesc;
    }

    public void setTransferStatusesDesc(String transferStatusesDesc) {
        this.transferStatusesDesc = transferStatusesDesc;
    }
}
