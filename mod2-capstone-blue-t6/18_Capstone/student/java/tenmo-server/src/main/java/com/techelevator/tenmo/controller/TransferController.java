...
@RestController
@PreAuthorize("isAuthenticated")  //authenticate (only people with tokens can access)
public class TransferController {
    ...
    public String getTransferSend (@RequestBody TransferDTO transferDTO){  //, @requestbody transfer transfer
       ...
       int userIdFrom = transferDTO.getUserIdFrom();  //use principle so people cant force with postman
